...
public class NewsMain {
  ...
  public static void main(String[] args) {
    ...
    new News(101, "Rajnikanth", "Mahesh", "I watched your movie"),
    ...
    new News(104, "Akshay Kumar", "Rajesh", " Your movies are of low Budget"),
    new News(101, "Akshay Kumar", "Mahesh", " Your movies are of minimal Budget")
    ); 
